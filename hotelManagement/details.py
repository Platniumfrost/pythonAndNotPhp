...
class DetailsRoom:
    def __init__(self,root):
        ...
        #label Frame------------------------------------------------------------------
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="New Room Added",font=("arial",12,"bold"),padx=2)
    ...
    #_______________ADD DATA_____________________________
    def add_data(self):
