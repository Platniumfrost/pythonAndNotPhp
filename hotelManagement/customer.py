...
class Cust_Win:
    def __init__(self,root):
        ...
        combo_Nationality["value"]=("Indian","American","Canadian","German","British","Russian")
        ...
        # address
        lblAddress=Label(labelframeleft,font=("arial",12,"bold"),text="Adress:",padx=2,pady=6)
        ...
        self.Cust_Details_Table=ttk.Treeview(details_table,column=("ref","name","mother","gender","post","mobile",
                                                                    "email","nationality","idproof","idnumber","address"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y)
